...
public:
    ...
    // Make currentCanvas a static member
...
static void display() {
    Canvas::currentCanvas->clear_screen();
    Canvas::currentCanvas->set_color(0, 0, 0);
    Canvas::currentCanvas->line_to(250, 350);
    Canvas::currentCanvas->arrow(150, 100, 70, 70);
    Canvas::currentCanvas->swap();
}
...
int main(int argc, char** argv) {
    ...
    Canvas arrow_cvs(640, 480, "An arrow marker");
    arrow_cvs.set_bc(1.0, 1.0, 1.0);
    arrow_cvs.clear_screen();
    arrow_cvs.set_color(0, 0, 0);
    arrow_cvs.line_to(250, 350);
    arrow_cvs.arrow(150, 100, 70, 70);
    arrow_cvs.swap();

    // Set the display callback function
    Canvas::currentCanvas = &arrow_cvs;
    glutDisplayFunc(display);  // Use the function name directly
